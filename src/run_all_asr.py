...
STEPS = ["fetch_asr_data.py", "mix_asr_noise.py", "test_asr_vi.py", "test_asr_multi.py"]
...
def main():
    ...
    print("\n[run_all_asr] Done. See outputs/asr_vi_results.csv and "
          "outputs/asr_multi_results.csv for WER/CER/RTF numbers.")
